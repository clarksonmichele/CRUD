...
// GET handler for add to display a blank form - get the form
...
// POST handler for add to process the form - post the form
router.post('/add', function(req, res, next) {

    // save a new article in db using our Article model and mongoose
    Article.create( {
